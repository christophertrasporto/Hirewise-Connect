...
export const AUDIT_ACTIONS = [
  ...
  "COACH_EVALUATION_RECORDED",
  "CERTIFICATION_ISSUED",
  "CERTIFICATION_REVOKED",
  "CERTIFICATION_EXPIRED",
  "CERTIFICATION_TEMPLATE_CHANGED",
  "VERIFICATION_REQUIREMENT_CHANGED",
  "VERIFICATION_RECOMPUTED",
  // Phase 4
  "BILLING_RATE_PROPOSED",
  "BILLING_RATE_PUBLISHED",
  "BILLING_RATE_REJECTED",
  "BILLING_RATE_RETIRED",
  "COMPENSATION_SET",
  "DEPOSIT_POLICY_CHANGED",
  "DEPOSIT_RECALCULATED",
  "INVOICE_ISSUED",
  "INVOICE_VOIDED",
  "PAYMENT_RECORDED",
  "PLACEMENT_APPROVED",
